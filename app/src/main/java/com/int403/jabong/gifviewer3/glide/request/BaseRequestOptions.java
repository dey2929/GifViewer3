...
import com.int403.jabong.gifviewer3.glide.load.Option;
import com.int403.jabong.gifviewer3.glide.load.Options;
import com.int403.jabong.gifviewer3.glide.load.Transformation;
import com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy;
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.BitmapDrawableTransformation;
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.BitmapEncoder;
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.CenterCrop;
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.CenterInside;
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.CircleCrop;
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.DownsampleStrategy;
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.Downsampler;
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.FitCenter;
...
import com.int403.jabong.gifviewer3.glide.load.resource.gif.GifDrawableTransformation;
import com.int403.jabong.gifviewer3.glide.load.resource.gif.StreamGifDecoder;
import com.int403.jabong.gifviewer3.glide.signature.EmptySignature;
...
public abstract class BaseRequestOptions<CHILD extends BaseRequestOptions<CHILD>>
  ...
  /**
   * Applies a multiplier to the {@link com.int403.jabong.gifviewer3.glide.request.target.Target}'s size before
   ...
   *                       {@link com.int403.jabong.gifviewer3.glide.request.target.Target}'s dimensions when
  ...
  /**
   * Sets the {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy} to use for this load.
   *
   * <p> Defaults to {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#AUTOMATIC}. </p>
   *
   * <p> For most applications {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#RESOURCE} is
   ...
   * using {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#DATA} or
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#ALL}. </p>
   *
   ...
   * {@link com.int403.jabong.gifviewer3.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.int403.jabong.gifviewer3.glide.request.target.Target}'s width and height with the
   ...
   * {@link com.int403.jabong.gifviewer3.glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  ...
  /**
   * Sets the value for key
   * {@link com.int403.jabong.gifviewer3.glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_QUALITY}.
   */
  ...
  /**
   * Applies {@link com.int403.jabong.gifviewer3.glide.load.resource.bitmap.CenterCrop} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context Any {@link Context}.
   * @see #optionalTransform(Class, com.int403.jabong.gifviewer3.glide.load.Transformation)
   ...
   *
   * @param context Any {@link Context}.
   * @see #transform(Class, com.int403.jabong.gifviewer3.glide.load.Transformation)
  ...
  /**
   * Applies {@link com.int403.jabong.gifviewer3.glide.load.resource.bitmap.FitCenter} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies {@link com.int403.jabong.gifviewer3.glide.load.resource.bitmap.CenterInside} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies the given {@link com.int403.jabong.gifviewer3.glide.load.Transformation} for
   * {@link Bitmap Bitmaps} to the default types ({@link Bitmap},
   * {@link BitmapDrawable}, and
   * {@link com.int403.jabong.gifviewer3.glide.load.resource.gif.GifDrawable})
   * and throws an exception if asked to transform an unknown type.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link Context}.
   * @param transformation Any {@link com.int403.jabong.gifviewer3.glide.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #optionalTransform(Context, com.int403.jabong.gifviewer3.glide.load.Transformation)
   * @see #optionalTransform(Class, com.int403.jabong.gifviewer3.glide.load.Transformation)
   */
   ...
   * {@link Bitmap Bitmaps} to the default types ({@link Bitmap},
   * {@link BitmapDrawable}, and
   * {@link com.int403.jabong.gifviewer3.glide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link Context}.
   * @param transformation Any {@link com.int403.jabong.gifviewer3.glide.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #transform(Context, com.int403.jabong.gifviewer3.glide.load.Transformation)
   * @see #transform(Class, com.int403.jabong.gifviewer3.glide.load.Transformation)
   */
  ...
  /**
   * Applies the given {@link com.int403.jabong.gifviewer3.glide.load.Transformation} for any decoded resource of
   ...
   * {@link com.int403.jabong.gifviewer3.glide.load.Transformation} for a resource type that already has a
   * {@link com.int403.jabong.gifviewer3.glide.load.Transformation} will override the previous call. </p>
   *
   ...
   * @param transformation The {@link com.int403.jabong.gifviewer3.glide.load.Transformation} to apply.
   */
  ...
  /**
   * Removes all applied {@link com.int403.jabong.gifviewer3.glide.load.Transformation Transformations} for all
   ...
   * {@link com.int403.jabong.gifviewer3.glide.TransitionOptions#dontTransition()}</p>
   */
