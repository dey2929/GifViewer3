...
public interface Transformation<T> extends Key {
   ...
   * com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  com.int403.jabong.gifviewer3.glide.request.target.Target#SIZE_ORIGINAL} to indicate the
