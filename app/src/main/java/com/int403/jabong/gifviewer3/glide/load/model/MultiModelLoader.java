...
import com.int403.jabong.gifviewer3.glide.load.data.DataFetcher.DataCallback;
 ...
 * com.int403.jabong.gifviewer3.glide.load.engine.DataFetcherGenerator} implementations and should try to avoid this
 * duplication. </p>
 */
