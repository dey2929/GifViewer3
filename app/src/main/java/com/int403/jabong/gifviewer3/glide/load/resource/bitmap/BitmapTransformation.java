...
/**
 * A simple {@link com.int403.jabong.gifviewer3.glide.load.Transformation} for transforming
 * {@link Bitmap}s that abstracts away dealing with
 * {@link com.int403.jabong.gifviewer3.glide.load.engine.Resource} objects for subclasses.
 *
 * Use cases will look something like this:
 * <pre>
 * <code>
 * public class FillSpace extends BaseBitmapTransformation {
 *     private static final String ID = "com.int403.jabong.gifviewer3.glide.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
   ...
   * {@link com.int403.jabong.gifviewer3.glide.request.target.Target#SIZE_ORIGINAL},
   * this class converts them to be the size of the Bitmap we're going to transform before calling
   * this method.
   *
   * @param pool        A {@link com.int403.jabong.gifviewer3.glide.load.engine.bitmap_recycle.BitmapPool} that can
