...
import com.int403.jabong.gifviewer3.glide.request.BaseRequestOptions;
import com.int403.jabong.gifviewer3.glide.request.FutureTarget;
import com.int403.jabong.gifviewer3.glide.request.Request;
import com.int403.jabong.gifviewer3.glide.request.RequestCoordinator;
import com.int403.jabong.gifviewer3.glide.request.RequestFutureTarget;
import com.int403.jabong.gifviewer3.glide.request.RequestListener;
import com.int403.jabong.gifviewer3.glide.request.RequestOptions;
import com.int403.jabong.gifviewer3.glide.request.SingleRequest;
import com.int403.jabong.gifviewer3.glide.request.ThumbnailRequestCoordinator;
import com.int403.jabong.gifviewer3.glide.request.target.PreloadTarget;
 ...
 * {@link com.int403.jabong.gifviewer3.glide.request.target.Target}.
 */
public class RequestBuilder<TranscodeType> implements Cloneable {
   ...
   * com.int403.jabong.gifviewer3.glide.load.model.ModelLoader}, {@link com.int403.jabong.gifviewer3.glide.load.ResourceDecoder},
   * and {@link com.int403.jabong.gifviewer3.glide.load.Transformation}s. However,
   * {@link com.int403.jabong.gifviewer3.glide.request.BaseRequestOptions#placeholder(int)} and
   * {@link com.int403.jabong.gifviewer3.glide.request.BaseRequestOptions#error(int)}, and
   ...
   * {@link #into(com.int403.jabong.gifviewer3.glide.request.target.Target)} is called. </p>
   *
  ...
  public RequestBuilder<TranscodeType> loadGeneric(@Nullable Object model) {
    this.model = model;
    isModelSet = true;
    return this;
  }
   ...
   * {@link com.int403.jabong.gifviewer3.glide.request.BaseRequestOptions#signature(com.int403.jabong.gifviewer3.glide.load.Key)} to
   ...
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#NONE} and/or
   * {@link com.int403.jabong.gifviewer3.glide.request.BaseRequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link com.int403.jabong.gifviewer3.glide.load.model.UriLoader}.
   */
...
*/
   ...
   * {@link com.int403.jabong.gifviewer3.glide.request.BaseRequestOptions#signature(com.int403.jabong.gifviewer3.glide.load.Key)}
...
*/
   ...
   * the {@link com.int403.jabong.gifviewer3.glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link com.int403.jabong.gifviewer3.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * using {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#NONE} via
   * {@link BaseRequestOptions#diskCacheStrategy(com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy)}
   * during development, and re-enabling the default
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#RESOURCE} for release builds. </p>
   *
   * @see #load(Integer)
   * @see com.int403.jabong.gifviewer3.glide.signature.ApplicationVersionSignature
   */
...
*/
   ...
   * @return The
   * {@link com.int403.jabong.gifviewer3.glide.request.target.Target} used to wrap the given {@link ImageView}.
   */
   ...
   *               overridden by
   *               {@link com.int403.jabong.gifviewer3.glide.request.BaseRequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see com.int403.jabong.gifviewer3.glide.ListPreloader
   */
