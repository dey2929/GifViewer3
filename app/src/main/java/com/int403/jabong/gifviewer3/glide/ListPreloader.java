...
import com.int403.jabong.gifviewer3.glide.request.target.BaseTarget;
 ...
 *
 * <p> Must be put using
 * {@link AbsListView#setOnScrollListener(AbsListView.OnScrollListener)}, or have its
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  /**
   * Constructor for {@link com.int403.jabong.gifviewer3.glide.ListPreloader} that accepts interfaces for providing
