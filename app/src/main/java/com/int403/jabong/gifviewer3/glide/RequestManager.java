...
import com.int403.jabong.gifviewer3.glide.load.resource.drawable.DrawableTransitionOptions;
import com.int403.jabong.gifviewer3.glide.load.resource.gif.GifDrawable;
import com.int403.jabong.gifviewer3.glide.manager.ConnectivityMonitor;
import com.int403.jabong.gifviewer3.glide.manager.ConnectivityMonitorFactory;
import com.int403.jabong.gifviewer3.glide.manager.Lifecycle;
import com.int403.jabong.gifviewer3.glide.manager.LifecycleListener;
import com.int403.jabong.gifviewer3.glide.manager.RequestManagerTreeNode;
import com.int403.jabong.gifviewer3.glide.manager.RequestTracker;
import com.int403.jabong.gifviewer3.glide.manager.TargetTracker;
...
import com.int403.jabong.gifviewer3.glide.request.target.ViewTarget;
...
import static com.int403.jabong.gifviewer3.glide.request.RequestOptions.decodeTypeOf;
import static com.int403.jabong.gifviewer3.glide.request.RequestOptions.diskCacheStrategyOf;
...
public class RequestManager implements LifecycleListener {
 ...
 /* public RequestManager applyDefaultRequestOptions(RequestOptions requestOptions) {
   ...
   * #setDefaultRequestOptions(RequestOptions)} and {
   * applyDefaultRequestOptions(RequestOptions)}.
   *
   * <p>Subsequent calls to {applyDefaultRequestOptions(RequestOptions)} will not mutate
 ...
 /* public void pauseRequestsRecursive() {
   ...
   * com.int403.jabong.gifviewer3.glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
  ...
  public RequestBuilder<Drawable> load(@Nullable Object model) {
    return asDrawable().loadGeneric(model);
  }
   ...
   * com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#DATA}. As a result, specifying a
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy} on this request is generally not
   * recommended.
   *
...
*/
   ...
   * {@link com.int403.jabong.gifviewer3.glide.load.ResourceDecoder}s
