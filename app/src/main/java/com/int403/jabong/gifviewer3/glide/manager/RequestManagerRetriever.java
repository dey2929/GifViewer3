...
/**
 * A collection of static methods for creating new {@link com.int403.jabong.gifviewer3.glide.RequestManager}s or
 * retrieving existing ones from activities and fragment.
 */
public class RequestManagerRetriever implements Handler.Callback {
  // Visible for testing.
  static final String FRAGMENT_TAG = "com.int403.jabong.gifviewer3.glide.manager";
