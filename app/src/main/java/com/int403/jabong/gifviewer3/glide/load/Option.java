package com.int403.jabong.gifviewer3.glide.load;
 ...
 * com.int403.jabong.gifviewer3.glide.load.engine.DiskCacheStrategy#RESOURCE}.
 *
 * <p>
...
public final class Option<T> {
   ...
   * com.int403.jabong.gifviewer3.glide.load.Option.CacheKeyUpdater} to update disk cache keys.
   *
   * @param key A unique package prefixed {@link String} that identifies this option (must be
   *            stable across builds, so {@link Class#getName()} should <em>not</em> be used).
   */
  ...
  /**
   * Returns a new {@link Option} that uses the given {@link
   * com.int403.jabong.gifviewer3.glide.load.Option.CacheKeyUpdater} to update disk cache keys and provides
   ...
   * value using the {@link com.int403.jabong.gifviewer3.glide.load.Option.CacheKeyUpdater} optionally provided in
   * the constructor.
   */
