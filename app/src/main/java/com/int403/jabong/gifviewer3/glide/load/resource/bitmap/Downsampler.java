...
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  /**
   * Indicates the {@link com.int403.jabong.gifviewer3.glide.load.DecodeFormat} that will be used in conjunction
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "com.int403.jabong.gifviewer3.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link com.int403.jabong.gifviewer3.glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("com.int403.jabong.gifviewer3.glide.load.resource.bitmap.Downsampler.DownsampleStrategy",
   ...
   * provided  {@link com.int403.jabong.gifviewer3.glide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
