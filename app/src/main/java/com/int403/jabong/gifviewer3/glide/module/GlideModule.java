package com.int403.jabong.gifviewer3.glide.module;

import android.content.Context;

import com.int403.jabong.gifviewer3.glide.GlideBuilder;
import com.int403.jabong.gifviewer3.glide.Registry;

/**
 * An interface allowing lazy configuration of Glide including setting options using
 * {@link com.int403.jabong.gifviewer3.glide.GlideBuilder} and registering
 * {@link com.int403.jabong.gifviewer3.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, com.int403.jabong.gifviewer3.glide.load.ResourceDecoder)} for each
 * {@link com.int403.jabong.gifviewer3.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * com.int403.jabong.gifviewer3.glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="com.int403.jabong.gifviewer3.glide.samples.flickr.FlickrGlideModule"
...
public interface GlideModule {
  ...
  /**
   * Lazily apply options to a {@link com.int403.jabong.gifviewer3.glide.GlideBuilder} immediately before the Glide
   * singleton is created.
   *
   * <p> This method will be called once and only once per implementation. </p>
   *
   * @param context An Application {@link Context}.
   * @param builder The {@link com.int403.jabong.gifviewer3.glide.GlideBuilder} that will be used to create Glide.
   */
   ...
   *
   * @param context  An Application {@link Context}.
   * @param registry An {@link com.int403.jabong.gifviewer3.glide.Registry} to use to register components.
   */
