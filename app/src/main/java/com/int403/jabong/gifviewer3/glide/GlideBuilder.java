...
import com.int403.jabong.gifviewer3.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.int403.jabong.gifviewer3.glide.load.engine.bitmap_recycle.LruArrayPool;
import com.int403.jabong.gifviewer3.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.int403.jabong.gifviewer3.glide.load.engine.cache.DiskCache;
import com.int403.jabong.gifviewer3.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.int403.jabong.gifviewer3.glide.load.engine.cache.LruResourceCache;
import com.int403.jabong.gifviewer3.glide.load.engine.cache.MemoryCache;
import com.int403.jabong.gifviewer3.glide.load.engine.cache.MemorySizeCalculator;
import com.int403.jabong.gifviewer3.glide.load.engine.executor.GlideExecutor;
import com.int403.jabong.gifviewer3.glide.manager.ConnectivityMonitorFactory;
import com.int403.jabong.gifviewer3.glide.manager.DefaultConnectivityMonitorFactory;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link com.int403.jabong.gifviewer3.glide.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link com.int403.jabong.gifviewer3.glide.load.engine.cache.MemoryCache} implementation to store
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link com.int403.jabong.gifviewer3.glide.load.engine.cache.DiskCache} implementation to use to store
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.Resource} data and thumbnails.
   *
   ...
   * use {@link #setDiskCache(com.int403.jabong.gifviewer3.glide.load.engine.cache.DiskCache.Factory)} instead.
  ...
  /**
   * Sets the {@link com.int403.jabong.gifviewer3.glide.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link com.int403.jabong.gifviewer3.glide.load.engine.cache.DiskCache} to use to store {@link
   * com.int403.jabong.gifviewer3.glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.Resource}s that are not already in the cache.
   *
   * <p> Any implementation must order requests based on their {@link com.int403.jabong.gifviewer3.glide.Priority}
  ...
  /**
   * Sets the {@link java.util.concurrent.ExecutorService} implementation to use when retrieving
   * {@link com.int403.jabong.gifviewer3.glide.load.engine.Resource}s that are currently in cache.
   *
   * <p> Any implementation must order requests based on their {@link com.int403.jabong.gifviewer3.glide.Priority}
   * for thumbnail requests to work properly.
   *
   ...
   * RequestBuilder#apply(com.int403.jabong.gifviewer3.glide.request.BaseRequestOptions)} will override defaults
   * set here.
   *
  ...
  /**
   * Sets the {@link com.int403.jabong.gifviewer3.glide.load.DecodeFormat} that will be the default format for all
   ...
   * com.int403.jabong.gifviewer3.glide.load.DecodeFormat} for more details. </p>
   *
  ...
  /**
   * Sets the {@link com.int403.jabong.gifviewer3.glide.manager.ConnectivityMonitorFactory}
   * to use to notify {@link com.int403.jabong.gifviewer3.glide.RequestManager} of connectivity events.
   * If not set {@link com.int403.jabong.gifviewer3.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
