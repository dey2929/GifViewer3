...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.int403.jabong.gifviewer3.glide.load.data.DataFetcher} and the
   * {@link com.int403.jabong.gifviewer3.glide.load.EncodeStrategy} of the
   * {@link com.int403.jabong.gifviewer3.glide.load.ResourceEncoder} (if an
   * {@link com.int403.jabong.gifviewer3.glide.load.ResourceEncoder} is available).
   */
   ...
   * com.int403.jabong.gifviewer3.glide.load.ResourceEncoder} will use to encode the resource.
   */
