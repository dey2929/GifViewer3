...
import com.int403.jabong.gifviewer3.glide.request.transition.NoTransition;
import com.int403.jabong.gifviewer3.glide.request.transition.TransitionFactory;
import com.int403.jabong.gifviewer3.glide.request.transition.ViewAnimationFactory;
import com.int403.jabong.gifviewer3.glide.request.transition.ViewPropertyAnimationFactory;
import com.int403.jabong.gifviewer3.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link com.int403.jabong.gifviewer3.glide.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
