...
/**
 * An {@link com.int403.jabong.gifviewer3.glide.load.ResourceEncoder} that writes {@link Bitmap}s
...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
  ...
  public static final Option<Integer> COMPRESSION_QUALITY = Option.memory(
      "com.int403.jabong.gifviewer3.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);
  ...
  public static final Option<Bitmap.CompressFormat> COMPRESSION_FORMAT = Option.memory(
      "com.int403.jabong.gifviewer3.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");
