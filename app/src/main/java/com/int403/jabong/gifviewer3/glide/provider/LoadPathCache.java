package com.int403.jabong.gifviewer3.glide.provider;

import android.support.annotation.Nullable;
import android.support.v4.util.ArrayMap;

import com.int403.jabong.gifviewer3.glide.load.engine.LoadPath;
import com.int403.jabong.gifviewer3.glide.util.MultiClassKey;

import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available
 * {@link com.int403.jabong.gifviewer3.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
