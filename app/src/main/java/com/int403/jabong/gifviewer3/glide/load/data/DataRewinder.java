...
public interface DataRewinder<T> {
   ...
   * {@link DataRewinder}s.
   *
   * @param <T> The type of data that the {@link com.int403.jabong.gifviewer3.glide.load.data.DataRewinder} will
   *            wrap.
   */
  interface Factory<T> {
    /**
     * Returns a new {@link com.int403.jabong.gifviewer3.glide.load.data.DataRewinder} wrapping the given data.
     */
