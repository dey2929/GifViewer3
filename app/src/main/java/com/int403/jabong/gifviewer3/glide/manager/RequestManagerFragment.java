...
import com.int403.jabong.gifviewer3.glide.RequestManager;
 ...
 * com.int403.jabong.gifviewer3.glide.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see com.int403.jabong.gifviewer3.glide.manager.SupportRequestManagerFragment
 * @see com.int403.jabong.gifviewer3.glide.manager.RequestManagerRetriever
 * @see com.int403.jabong.gifviewer3.glide.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.int403.jabong.gifviewer3.glide.RequestManager}.
   *
  ...
  /**
   * Returns the current {@link com.int403.jabong.gifviewer3.glide.RequestManager} or null if none exists.
   */
  @Nullable
