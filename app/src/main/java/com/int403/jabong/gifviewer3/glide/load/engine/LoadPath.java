...
/**
 * For a given {@link com.int403.jabong.gifviewer3.glide.load.data.DataFetcher} for a given data class, attempts to
 * fetch the data and then run it through one or more
 * {@link com.int403.jabong.gifviewer3.glide.load.engine.DecodePath}s.
 *
