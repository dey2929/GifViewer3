...
/**
 * A factory class that produces a functional {@link com.int403.jabong.gifviewer3.glide.manager.ConnectivityMonitor}
 * if the application has the {@code android.permission.ACCESS_NETWORK_STATE} permission and a no-op
 * non functional {@link com.int403.jabong.gifviewer3.glide.manager.ConnectivityMonitor} if the app does not have
