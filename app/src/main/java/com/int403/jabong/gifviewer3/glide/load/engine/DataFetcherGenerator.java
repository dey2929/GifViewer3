...
/**
 * Generates a series of {@link com.int403.jabong.gifviewer3.glide.load.data.DataFetcher DataFetchers} using
 * registered {@link com.int403.jabong.gifviewer3.glide.load.model.ModelLoader ModelLoaders} and a model.
 */
interface DataFetcherGenerator {
  /**
   * Called when the generator has finished loading data from a
   * {@link com.int403.jabong.gifviewer3.glide.load.data.DataFetcher}.
   */
  ...
  /**
   * Attempts to a single new {@link com.int403.jabong.gifviewer3.glide.load.data.DataFetcher} and returns true if
   * a {@link com.int403.jabong.gifviewer3.glide.load.data.DataFetcher} was started, and false otherwise.
   */
  boolean startNext();
