 ...
 *
 * @see com.int403.jabong.gifviewer3.glide.manager.RequestManagerFragment
...
public class SupportRequestManagerFragment extends Fragment {
  ...
  /**
   * Returns the current {@link com.int403.jabong.gifviewer3.glide.RequestManager} or null if none is put.
   */
  @Nullable
