 ...
 *
 * @param <T> The type of the model the {@link com.int403.jabong.gifviewer3.glide.load.model.ModelLoader}s built by
 *            this factory can handle
 * @param <Y> The type of data the {@link com.int403.jabong.gifviewer3.glide.load.model.ModelLoader}s built by this
 *            factory can load.
 */
