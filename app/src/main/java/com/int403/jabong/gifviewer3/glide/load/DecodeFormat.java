 ...
 * {@link android.graphics.Bitmap}s returned by {@link com.int403.jabong.gifviewer3.glide.load.ResourceDecoder}s.
 *
 * <p> Note - In some cases it may not be possible to obey the requested setting, not all
 * {@link com.int403.jabong.gifviewer3.glide.load.resource.bitmap.Downsampler}s support setting formats and certain
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.int403.jabong.gifviewer3.glide.load.ResourceDecoder}.
