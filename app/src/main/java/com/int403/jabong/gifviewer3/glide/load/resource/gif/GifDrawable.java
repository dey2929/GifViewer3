...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param bitmapPool          A {@link com.int403.jabong.gifviewer3.glide.load.engine.bitmap_recycle.BitmapPool}
   *                            that can be used to return the first frame when this drawable is
   *                            recycled.
   * @param frameTransformation An {@link com.int403.jabong.gifviewer3.glide.load.Transformation} that can be
   ...
   * @see #setFrameTransformation(com.int403.jabong.gifviewer3.glide.load.Transformation, Bitmap)
   */
