...
import com.int403.jabong.gifviewer3.glide.load.model.ModelLoader.LoadData;
import com.int403.jabong.gifviewer3.glide.util.LogTime;

import java.util.Collections;

/**
 * Generates {@link com.int403.jabong.gifviewer3.glide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link com.int403.jabong.gifviewer3.glide.load.model.ModelLoader ModelLoaders} and the model
