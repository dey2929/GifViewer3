...
import com.int403.jabong.gifviewer3.glide.load.resource.bitmap.RecyclableBufferedInputStream;
...
public final class InputStreamRewinder implements DataRewinder<InputStream> {
  ...
  /**
   * Factory for producing {@link com.int403.jabong.gifviewer3.glide.load.data.InputStreamRewinder}s from {@link
   * InputStream}s.
   */
