...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
   ...
   * com.int403.jabong.gifviewer3.glide.request.Request}. </p>
   */
  @Override
  @Nullable
   ...
   *   on older versions, be sure to call {@link com.int403.jabong.gifviewer3.glide.RequestManager#clear(View)} on
